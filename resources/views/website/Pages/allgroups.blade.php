...
<div class="content-wrapper">
    <div id="users-table">
        <div class="card card-rounded">
            <div class="card-body">
                <h3 class="card-title">All Groups Information</h3>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$user->id}}</td>
                            <td class="py-1">{{$user->group_name}}</td>
                            <td>{{$user->total_member}} Members</td>
                                    ...
                                    <div class="modal-dialog px-5">
                                        ...
                                        <div class="modal-body text-center">
                                           ...
                                           <div class="py-3"><h2 class="display-3">Are You Sure?</h2></div>
                                            <p class="text-lead">Do you really want to delete <span class="text-dark fw-bold">{{$user->group_name}}</span> ? This process cannot be undone.</p>
